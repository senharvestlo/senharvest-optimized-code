    ...
    <div className="max-w-6xl mx-auto p-4 space-y-4">
      ...
      <div className="bg-white border rounded p-3 grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="flex items-end">
          <button onClick={onDownload} className="w-full px-3 py-2 border rounded">
            Download PDF
          </button>
        </div>
      ...
      >
        ...
        <div className="mt-8 border-t pt-6">
          ...
          <p className="text-xs text-gray-600">
            ...
            <strong>INCOTERMS 2010</strong> – INCOTERMS ARE STANDARD TRADE DEFINITIONS MOST COMMONLY USED IN INTERNATIONAL SALES CONTRACTS: http://www.iccwbo.org/incoterms/understanding.asp
          </p>
        </div>

        {/* EDT */}
        <div className="mt-8 bg-gray-50 p-5 rounded border">
          ...
          <ol className="list-decimal ml-6 mt-2 text-sm text-justify leading-relaxed space-y-2">
        ...
        <div className="mt-12">
          ...
          {/* Party 1 */}
          <div className="bg-blue-50 p-5 rounded border mb-8">
            <h3 className="font-semibold text-blue-800 mb-4">Party 1:</h3>
            <div className="space-y-2 text-sm">
              <p><strong>Full Name/Title:</strong> {form.party1.nameTitle || '___________________'}</p>
              <p><strong>Corporation:</strong> {form.party1.company || '___________________'}</p>
              <p><strong>Address:</strong> {form.party1.address || '___________________'}</p>
              <p><strong>Tel:</strong> {form.party1.phone || '___________________'}</p>
              <p><strong>E-mail:</strong> {form.party1.email || '___________________'}</p>
            </div>
          </div>
          ...
          <div className="text-center mb-6">
            ...
            <p><strong>Name:</strong> {form.party1.nameTitle || '___________________'}</p>
            <p><strong>Position:</strong> {form.party1.position || '___________________'}</p>
          </div>

          {/* Party 2 */}
          <div className="bg-green-50 p-5 rounded border mb-8">
            <h3 className="font-semibold text-green-800 mb-4">Party 2:</h3>
            <div className="space-y-2 text-sm">
              <p><strong>Full Name/Title:</strong> {form.party2.nameTitle || '___________________'}</p>
              <p><strong>Corporation:</strong> {form.party2.company || '___________________'}</p>
              <p><strong>Address:</strong> {form.party2.address || '___________________'}</p>
              <p><strong>Tel:</strong> {form.party2.phone || '___________________'}</p>
              <p><strong>E-mail:</strong> {form.party2.email || '___________________'}</p>
            </div>
          </div>
          ...
          <div className="text-center mb-6">
            <p className="font-semibold">Authorized Signature and Corporate Seal</p>
            <div className="border-t border-black w-56 mx-auto mt-8 mb-2"></div>
            <p><strong>Name:</strong> {form.party2.nameTitle || '___________________'}</p>
            <p><strong>Position:</strong> {form.party2.position || '___________________'}</p>
          </div>

          {/* Broker (optionnel) */}
          {form.includeBroker && (
            <>
              <div className="bg-purple-50 p-5 rounded border mb-8">
                <h3 className="font-semibold text-purple-800 mb-4">Broker (Intermediary):</h3>
                <div className="space-y-2 text-sm">
                  <p><strong>Full Name/Title:</strong> {form.broker.nameTitle || '___________________'}</p>
                  <p><strong>Corporation:</strong> {form.broker.company || '___________________'}</p>
                  <p><strong>Address:</strong> {form.broker.address || '___________________'}</p>
                  <p><strong>Tel:</strong> {form.broker.phone || '___________________'}</p>
                  <p><strong>E-mail:</strong> {form.broker.email || '___________________'}</p>
                </div>
              </div>
              ...
              <div className="text-center mb-6">
                <p className="font-semibold">Authorized Signature and Corporate Seal</p>
                <div className="border-t border-black w-56 mx-auto mt-8 mb-2"></div>
                <p><strong>Name:</strong> {form.broker.nameTitle || '___________________'}</p>
                <p><strong>Position:</strong> {form.broker.position || '___________________'}</p>
              </div>
            </>
          )}
        </div>
        ...
        {/* Notes */}
        <div className="border-t pt-6 mt-8 text-xs text-gray-600">
