...
import QuotationQwen from '../docs/QuotationQwen';
import { saveTradeDoc, getTradeDoc } from '../../services/firebaseService';

export default function QuotationQwenWrapper({ docId, onBack }) {
  ...
  return <QuotationQwen initialData={initialData} onSave={handleSave} onBack={onBack} />;
}
